	...
	<div class="nav">
		<div class="nav-list">
			...
			<div class="personal-list" id="info_child">
				<ul>
					<li><a href="StuInfoFind" target="main" style="margin-left: 15px;">公司信息</a></li>
			...
			<div class="personal-list" id="project_child">
				<ul>
					<li><a href="AllProjDisp?type=stu" target="main">当前项目列表</a></li>
					<li><a href="stu_history.jsp" target="main">历史项目列表</a></li>
				</ul>
			</div>
			<div class="nav-tit">
				<a href="stu_pwd_change.jsp" target="main">
					<img src="images/modify-password.png" alt="">
					<span>修改密码</span>
				</a>
			</div>
			<div class="nav-tit">
				<a href="stu_right.jsp" target="main">
