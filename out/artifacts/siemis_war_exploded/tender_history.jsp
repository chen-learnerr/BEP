        ...
        <div class="unit-information">
            ...
            <div class="unit-list clearfix">
	           <form action = "HistProjQuery" method = "post">
	               ...
	               <div class="querycol"><label>开设学校</label> : <input type="text" value="" name="proj_school"  id="proj_school"/></div>
	               <div class="querycol"><label>所在国家</label> : <input type="text" value="" name="proj_country" id="proj_country"/></div>
	               <input type="hidden" value="isTender" id="isTender" name="isTender"/>
                       ...
                       <%
                        ...
                        if(list != null){
                        	for(int i=0;i<list.size();i++){
                        		...
                        		if(historyproj_info.getProj_start_time().before(cur_date)) {
                    %>
                    <tr>
