...
<body>
    <div class="content">
        ...
        <div class="unit-information">
            ...
            <form action = "AdminStuProQuery?proj_no=<%=proj_no %>"  method = "post">
                <div class="querycol"><label>学生姓名</label> : <input type="text" value="" name="stu_name" id="stu_name" /></div>
                <div class="querycol"><label>学号</label> : <input type="text" value="" name="stu_num" id="stu_num" /></div>
                <div class="querycol"><label>年级</label> : <input type="text" value="" name="stu_grd" id="stu_grd" /></div>
