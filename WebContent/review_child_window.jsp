		...
		function reviewSubmit(a, b) {
			...
			if(proj_status == "") {
		        ...
		        if(confirm(msg)==true){
					...
					var params="proj_no="+a+"&bidder_num="+b+"&proj_status="+proj_status;
...
<body>
	...
	<%
		...
		String bidder_num = (String)request.getParameter("bidder_num");
	%>
	<form action="">
		...
		<input type="button" value="提交" onclick="reviewSubmit(<%=proj_no %>, <%=bidder_num %>)"/>
	</form>
</html>